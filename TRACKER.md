...
- [ ] AWS Topic 1 — Core networking (VPC, subnets, route tables, NAT, IGW)

## Track A: Designing Data-Intensive Applications

| Ch | Title | Pages | Digested | Carousel | Notes |
|---:|-------|-------|----------|----------|-------|
| 1 | Reliable, Scalable, and Maintainable Applications | 25–48 | 2026-07-18 | 2026-07-18 | Full chapter in one digest; outside example = 2017 AWS S3 outage |
...
| Ch | Title | Pages | Digested | Carousel | Notes |
|---:|-------|-------|----------|----------|-------|
| 1 | Introduction to Building AI Applications with Foundation Models | 25-72 | 2026-07-18 | 2026-07-18 | Full chapter in one digest; outside example = Notion AI |
...
| Ch | Title | Pages | Digested | Carousel | Notes |
|---:|-------|-------|----------|----------|-------|
| 1 | MySQL Architecture | 23-40 | 2026-07-18 | 2026-07-18 | Full chapter in one digest; outside example = Facebook's MyRocks (2016) |
...
|--:|-------|--------|----------|----------|-------|
| 1 | Core networking (VPC, subnets, route tables, NAT, IGW) | docs.aws.amazon.com | 2026-07-18 | 2026-07-18 | 12 VPC User Guide / CLI ref pages fetched live, see digest's Sources & verify |
