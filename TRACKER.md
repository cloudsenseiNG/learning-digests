...
- [ ] Designing Data-Intensive Applications — Ch.1: Reliable, Scalable, and Maintainable Applications
- [ ] AI Engineering — Ch.1 (Part 1, pages 25-43): Foundation Models, and Why "AI Engineering" Became a Job
...
| Ch | Title | Pages | Digested | Carousel | Notes |
|---:|-------|-------|----------|----------|-------|
| 1 | Introduction to Building AI Applications with Foundation Models | 25-72 | 2026-07-20 (Part 1, pp.25-43) | 2026-07-20 | In progress: covered language models → foundation models → AI engineering's growth drivers → use-case frameworks. Remaining: pp.44-72 (individual use-case walkthroughs) next batch. |
...
|--:|-------|--------|----------|----------|-------|
| 1 | Core networking (VPC, subnets, route tables, NAT, IGW) | docs.aws.amazon.com | 2026-07-20 | 2026-07-20 | |
